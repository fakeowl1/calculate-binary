# Конвертор
Невеличка реалізація конвертора чисел у двійковий код для виконання лабораторної роботи №2 з Системного Програмування. Павлов В.Г - іді нахуй. Заїбав.
...
func main() {
	...
	fmt.Printf("\nWord A (13):    %v\n", bitsA16)
	fmt.Printf("Word -A (-13):  %v\n", GetTwosComplement(bitsA16, 16))
	fmt.Printf("Word B (1306):  %v\n", bitsB16)
	...
	fmt.Printf("\nShortInt A (13):    %v\n", bitsA32)
	fmt.Printf("ShortInt -A (-13):  %v\n", GetTwosComplement(bitsA32, 32))
	fmt.Printf("ShortInt B (1306):  %v\n", bitsB32)
	fmt.Printf("ShortInt -B (-13606):%v\n", GetTwosComplement(bitsB32, 32))
	...
	fmt.Printf("\nLongInt A (13):    %v\n", bitsA64)
	fmt.Printf("LongInt -A (-13):  %v\n", GetTwosComplement(bitsA64, 64))
	fmt.Printf("LongInt B (1306):  %v\n", bitsB64)
